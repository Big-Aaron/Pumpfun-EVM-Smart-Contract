...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, uint256 supply, uint256 _maxTx) {
        _name = name_;
        _symbol = symbol_;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!isExcludedFromMaxTx[from]) require(amount <= maxTxAmount, "Exceeds the MaxTxAmount. ");
